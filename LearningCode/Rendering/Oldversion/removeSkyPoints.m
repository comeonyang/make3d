...
% *
% */
function [TriPoints,Position3Dcoord]=removeSkyPoints(maskSky,indexArray,num,TriPoints, ray, depth, VertYNuDepth, HoriXNuDepth, Position3Dcoord,i,j)
...
for iA=1+((num-1)*3):3+((num-1)*3) %% triangle
    if (maskSky(indexArray(1,iA),indexArray(2,iA))==1)
        ...
        Position3Dcoord(3,Imgindex) = -Position3Dcoord(3,Imgindex);
    end
