...
% *
% */
function Default = SetupDefault_skiny(taskName, ParaFolder, OutPutFolder, ScratchFolder, Flag)
...
Default.fy = 2407.3312729885838;
Default.Oy = 1110.7122391785729;%2272/2; %
Default.Ox = 833.72104535435108;%1704/2; %
Default.a_default = 1704/Default.fy; %0.70783777; %0.129; % horizontal physical size of image plane normalized to focal length (in meter)
Default.b_default = 2272/Default.fx; %0.946584169;%0.085; % vertical physical size of image plane normalized to focal length (in meter)
Default.Ox_default = 1-Default.Ox/1704;%0.489272914; % camera origin offset from the image center in horizontal direction
Default.Oy_default = 1-Default.Oy/2272;%0.488886982; % camera origin offset from the image center in vertical direction
