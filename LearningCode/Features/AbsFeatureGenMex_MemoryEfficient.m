...
% *
% */
function [f, fInd] = AbsFeatureGenMex(Default, SmallSup, HiSupi, SupMaskFlag, FeaMax, fInd)
...
gridinfo = [Default.TrainHoriXSize Default.HoriXNuDepth Default.HoriXNuPatch; Default.TrainVerYSize Default.VertYNuDepth Default.VertYNuPatch];
...
%               [floor(ratio(1)), floor(ratio(2))]
   ...
   DepthGridSizeY = ImgResY/Default.VertYNuDepth;
   DepthGridSizeX= ImgResX/Default.HoriXNuDepth;
