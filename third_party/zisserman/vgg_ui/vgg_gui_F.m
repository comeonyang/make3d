...
if strcmp(action,'start'),
   ...
   ah1 = axes('Parent', h0, ...
	      'Position',[0 0 .5 1]);
%    h1=imshow(i1); 
   h1 = imagesc(i1) ; colormap gray ; axis image ; axis off ;% min midified
   hold on; title('Image 1');
   ...
   ah2 = axes('Parent',h0, ...
	      ...
	      'Tag','Axes2');
%    h2=imshow(i2);
   h2 = imagesc(i2) ; colormap gray ; axis image ; axis off ;% min midified
   hold on; title('Image 2');
