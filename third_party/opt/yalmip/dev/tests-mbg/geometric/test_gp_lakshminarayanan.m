...
mbg_asserttolequal(norm(obj3d) + norm(obj2d) + norm(objstripMP) + norm(objstrip1P),1.742627952792674e+002,1e-5);
...
solvesdp(F,obj, sdpsettings('verbose',0,'solver','bnb','debug',1));
...
solvesdp(F,obj, sdpsettings('verbose',0,'solver','bnb'));
