...
% *
% */
function [] = OcclusionRemoveRefineMent(defaultPara, Wrlname, PairList, PostFixStrAfter)
...
for i = 1:NumImg
    ...
    if ~defaultPara.Flag.FlagPreloadOccluDetect
        [PointPix1 PointDepth1 FaceSetPickedIND1 POriReprojM1 FieldOccluPix1 OccluDist1 OccluedFaceSetIND1 ...
            ...
            FindOccluPair(defaultPara, ImgInfo1, ImgInfo2, Pair, GlobalScale, 0); % detect occlsion (use Ray as detector not the surf Features)
