...
# Run the m-file
matlab -nojvm -nodisplay > OccluCorrRecipicalMatch.out << EOF
...
tic;
OcclusionRefinement(defaultPara, WrlName, PairList,'TestOccluCorrRecipicalMatches','Corrmatches');
toc;
...
# Display the output
cat OccluCorrRecipicalMatch.out
