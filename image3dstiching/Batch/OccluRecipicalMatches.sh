...
# Run the m-file
matlab -nojvm -nodisplay > OccluRecipicalMatches.out << EOF
...
tic;
OcclusionRefineMent(defaultPara, WrlName, PairList,'TestOccluRecipicalMatches','matches');
toc;
