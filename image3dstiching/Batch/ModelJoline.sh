...
# Run the m-file
matlab -nojvm -nodisplay > ModelJoline.out << EOF

% Run your MATLAB commands inlin
cd ..
Fdir ='/afs/cs/group/reconstruction3d/scratch/TestMultipleImage/Joline';
WlrName = 'Jolinetest1'
...
PairList = [];
PairList = [ PairList; {'Joline001','Joline002'}];
PairList = [ PairList; {'Joline002','Joline003'}];
%PairList = [ PairList; {'Joline003','Joline004'}];
