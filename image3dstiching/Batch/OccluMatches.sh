...
# Run the m-file
matlab -nojvm -nodisplay > OccluMatches.out << EOF
...
tic;
OcclusionRefineMent(defaultPara, WrlName, PairList,'TestOccluRecipicalMatchesCorrRefine','matches');
toc;
