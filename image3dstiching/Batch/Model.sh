...
WlrName = 'GateMetaTestGateHilbertFixScalingRemoveOcclu_thre1'
PairList = [];
if false %GateMetaTestGates2Hilber
%	PairList = [ PairList; {'IMG_0663','IMG_0668'}];
	PairList = [ PairList; {'IMG_0669','IMG_0668'}];
	PairList = [ PairList; {'IMG_0668','IMG_0677'}];
%	PairList = [ PairList; {'IMG_0677','IMG_0675'}];
%	PairList = [ PairList; {'IMG_0675','IMG_0676'}];
end
if false
	PairList = [ PairList; {'IMG_0677','IMG_0675'}];
	PairList = [ PairList; {'IMG_0675','IMG_0676'}];
...
if false % 2Img
%	PairList = [ PairList; {'IMG_0670','IMG_0671'}];
	PairList = [ PairList; {'IMG_0671','IMG_0673'}]; % test little translation cases
end
if false
	PairList = [ PairList; {'IMG_0676','IMG_0675'}];
...
if true %GateMetaTestGateHilbertFixScalingRemoveOcclu
%	PairList = [ PairList; {'IMG_0669','IMG_0664'}];
	PairList = [ PairList; {'IMG_0665','IMG_0668'}];
	PairList = [ PairList; {'IMG_0668','IMG_0677'}];
	PairList = [ PairList; {'IMG_0677','IMG_0675'}];
	PairList = [ PairList; {'IMG_0675','IMG_0676'}];
end
if false % GateMetaTestGatesMoreHilberLittle_ImgInfoFixed2
	PairList = [ PairList; {'IMG_0669','IMG_0663'}];
...
tic;
main( Fdir, PairList, WlrName, 0, Flag);
toc;
