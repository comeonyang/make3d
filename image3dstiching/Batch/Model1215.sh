...
PairList = [];
%PairList = [ PairList; {'IMG_0125','IMG_0126'}];
%PairList = [ PairList; {'IMG_0125','IMG_0135'}];
%PairList = [ PairList; {'IMG_0125','IMG_0136'}];
PairList = [ PairList; {'IMG_0125','IMG_0135'}];
%PairList = [ PairList; {'IMG_0126','IMG_0136'}];
PairList = [ PairList; {'IMG_0135','IMG_0136'}];
