...
# Run the m-file
matlab -nojvm -nodisplay > ModelEV.out << EOF

% Run your MATLAB commands inlin
cd ..
Fdir ='/afs/cs/group/reconstruction3d/scratch/TestMultipleImage/EV';
WlrName = 'EVtest1'
...
PairList = [];
PairList = [ PairList; {'P1050129','P1050133'}];
%PairList = [ PairList; {'P1050129','P1050137'}];
PairList = [ PairList; {'P1050133','P1050137'}];
