...
# Run the m-file
matlab -nojvm -nodisplay > ModelMcCosh.out << EOF

% Run your MATLAB commands inlin
cd ..
Fdir ='/afs/cs/group/reconstruction3d/scratch/TestMultipleImage/McCosh';
WlrName = 'McCoshtest1'
...
PairList = [];
PairList = [ PairList; {'McCosh003','McCosh004'}];
%PairList = [ PairList; {'McCosh003','McCosh005'}];
%PairList = [ PairList; {'McCosh004','McCosh005'}];
