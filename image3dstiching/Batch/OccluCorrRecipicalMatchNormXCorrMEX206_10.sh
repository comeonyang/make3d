...
# Run the m-file
matlab -nojvm -nodisplay > OccluCorrRecipicalMatchNormXCorrMEX2.out << EOF
...
tic;
OcclusionRefinement(defaultPara, WrlName, PairList(1,:),'TestOccluCorrRecipicalMatches','Corrmatches');
toc;
...
# Display the output
cat OccluCorrRecipicalMatchNormXCorrMEX2.out
