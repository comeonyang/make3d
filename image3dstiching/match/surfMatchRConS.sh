...
#        -k2 $dir/surf/$img2.surf_64 $gen | sed -e 's/ Matched feature //g' | \
   ../../third_party/SURF-V1.0.8/symmatchRConS_thre.ln \
	-abs $abs_thre -ratio $ratio_thre \
	-S1 $dir/surf/RConS_$img1.txt \
	-S2 $dir/surf/RConS_$img2.txt \
	-RS1 $dir/surf/RConSRough_$img1.txt \
	-RS2 $dir/surf/RConSRough_$img2.txt \
	-k1 $dir/surf/$img1.surf$Type \
        -k2 $dir/surf/$img2.surf$Type \
	$gen | sed -e 's/ Matched feature //g' | \
        sed -e 's/ in image 1 with feature / /g' | \
        sed -e 's/ in image 2\.//g' | sed '$d' > $dir/surf_matches/$img1-$img2.match_RConS$Type"_"$abs_thre"_"$ratio_thre
#        sed -e 's/ in image 2\.//g' | sed '$d' > $dir/surf_matches/$img1-$img2.match_RConS$Type
#        sed -e 's/ in image 2\.//g' | sed '$d' > $dir/surf_matches/$img1-$img2.match_64
fi
