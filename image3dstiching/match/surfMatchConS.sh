...
#        -k2 $dir/surf/$img2.surf_64 $gen | sed -e 's/ Matched feature //g' | \
   ../../third_party/SURF-V1.0.8/symmatchConS.ln \
	-S1 $dir/surf/ConS_$img1.txt \
	-S2 $dir/surf/ConS_$img2.txt \
	-k1 $dir/surf/$img1.surf \
        -k2 $dir/surf/$img2.surf \
	$gen | sed -e 's/ Matched feature //g' | \
        sed -e 's/ in image 1 with feature / /g' | \
        sed -e 's/ in image 2\.//g' | sed '$d' > $dir/surf_matches/$img1-$img2.match_ConS
