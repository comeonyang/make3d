...
#        -k2 $dir/surf/$img2.surf_64 $gen | sed -e 's/ Matched feature //g' | \
   #../../third_party/SURF-V1.0.8/OcluMatchRConS_thre.ln \
   ../../third_party/SURF-V1.0.8/OcluMatchRConS_thre.ln \
	...
	-k1 $dir/surf/$img1.surfDense \
        -k2 $dir/surf/$img2.surfDense \
	$gen | sed -e 's/ Matched feature //g' | \
        sed -e 's/ in image 1 with feature / /g' | \
        sed -e 's/ in image 2//g' | \
        sed -e 's/ Ratio//g' | \
	sed '$d' > $dir/surf_matches/$img1-$img2.match_RConS$Type
