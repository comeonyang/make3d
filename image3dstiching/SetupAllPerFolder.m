...
% *
% */
function [defaultPara ImgInfo] = SetupAllPerFolder( Fdir)

% This function setup Parameter GPS and IMU and Exif info
% For further processing

% initialize parameters
Stiching3dParameterSetup % script file to setup the while defaultPara
% -----------------------------------------------------------------
