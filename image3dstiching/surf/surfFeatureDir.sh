...
# Usage ./surfFeatureDir.sh <dir>
#
# Data:
#      *.jpg in the dir/jpg/ folder
# 
# Create:
#  by surfFeatureDir.sh
#  1) dir/pgm : lowest common denominator grayscale file format of the original *.jpg
#  2) dir/surf: surf features descriptor vecto       

dir=$1
echo "Creating surf features for images in $dir"

files=`ls $dir/jpg/ | sed -e 's/\.jpg//g'`
...
for img in $files; do
    ...
    ../../third_party/SURF-V1.0.8/surf.ln -i $dir/pgm/$img.pgm -o $dir/surf/$img.surf -d -u -e 
